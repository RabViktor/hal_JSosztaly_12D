...
function halinfo(halnev){
    document.getElementById("sugo").style.display = "none"
    document.getElementById("halKep").src = "halak/"+halak[halnev].kep
    document.getElementById("halNevek").innerHTML = "<b>" + halak[halnev].magyar + "</b>, <i>" + halak[halnev].latin + "</i>"
    if(halak[halnev].egyeb != null){
        document.getElementById("halNevek").innerHTML += ", "+halak[halnev].egyeb
    }
    document.getElementById("halURL").title = `${halak[halnev].magyar}, ${halak[halnev].url}`
}